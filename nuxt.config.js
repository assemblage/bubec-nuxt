...
export default async () => {
    ...
    head: {
      ...
      link: [
        ...
        { rel: 'icon', type: 'image/png', sizes: "144x144", href: '/favicons/android-chrome-144x144.png', media: '(prefers-color-scheme:light)' },
        ...
        { rel: 'icon', type: 'image/x-icon', href: '/favicons/favicon.ico', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "16x16", href: '/favicons/favicon-16x16.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "32x32", href: '/favicons/favicon-32x32.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "144x144", href: '/favicons/android-chrome-144x144.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', name: 'msapplication-TileImage', sizes: "150x150", content: '/favicons/mstile-150x150.png', media: '(prefers-color-scheme:dark)' },
        { hid: 'apple-touch-icon', rel: 'apple-touch-icon', sizes: '180x180', href: '/favicons/apple-touch-icon.png', media: '(prefers-color-scheme:dark)'},
        {
          rel:"preconnect",
