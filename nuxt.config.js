...
export default async () => {
    ...
    head: {
      ...
      link: [
        ...
        { rel: 'icon', type: 'image/png', sizes: "192x192", href: '/favicons/android-chrome-192x192.png', media: '(prefers-color-scheme:light)' },
        { rel: 'icon', name: 'msapplication-TileImage', sizes: "150x150", content: '/favicons/mstile-150x150.png', media: '(prefers-color-scheme:light)' },
        { hid: 'apple-touch-icon', rel: 'apple-touch-icon', sizes: '180x180', href: '/favicons/apple-touch-icon.png', media: '(prefers-color-scheme:light)'},
        { rel: 'icon', type: 'image/x-icon', href: '/favicons/dark/favicon.ico', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "16x16", href: '/favicons/dark/favicon-16x16.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "32x32", href: '/favicons/dark/favicon-32x32.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', type: 'image/png', sizes: "192x192", href: '/favicons/dark/android-chrome-192x192.png', media: '(prefers-color-scheme:dark)' },
        { rel: 'icon', name: 'msapplication-TileImage', sizes: "150x150", content: '/favicons/dark/mstile-150x150.png', media: '(prefers-color-scheme:dark)' },
        { hid: 'apple-touch-icon', rel: 'apple-touch-icon', sizes: '180x180', href: '/favicons/dark/apple-touch-icon.png', media: '(prefers-color-scheme:dark)'},
        {
          rel:"preconnect",
